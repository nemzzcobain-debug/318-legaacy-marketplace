...
import {
  ListMusic, Plus, Globe, Lock, Music, Trash2, Edit3, X, Loader2, Search
} from 'lucide-react'
...
export default function PlaylistsPage() {
  ...
  const genreColors: Record<string, string> = {
    'Trap': 'bg-purple-500/20 text-purple-400',
    'Drill': 'bg-red-500/20 text-red-400',
    'Boom Bap': 'bg-yellow-500/20 text-yellow-400',
    'R&B': 'bg-pink-500/20 text-pink-400',
    'Afrobeat': 'bg-green-500/20 text-green-400',
    'Pop': 'bg-blue-500/20 text-blue-400',
    'Lo-Fi': 'bg-cyan-500/20 text-cyan-400',
  }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Organise tes beats favoris en collections</p>
          </div>
          {session && (
            <button
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setShowCreate(false)}>
            <div className="w-full max-w-md mx-4 glass rounded-2xl p-6" onClick={e => e.stopPropagation()}>
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-lg font-bold">Nouvelle Playlist</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-1">Visibilité</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map(playlist => (
              ...
              >
                ...
                {/* Info */}
                <div className="p-4">
                  <h3 className="font-bold text-white truncate group-hover:text-red-400 transition-colors">{playlist.name}</h3>
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-400">{playlist.user.displayName || playlist.user.name}</span>
                    </div>
                    {tab === 'mine' && (
                      <button
