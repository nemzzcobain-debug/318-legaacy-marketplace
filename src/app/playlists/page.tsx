...
interface PlaylistItem {
  ...
  beats: {
    beat: { id: string; title: string; coverImage: string | null; genre: string; bpm: number }
  }[]
  _count: { beats: number }
}
    ...
    <div className="min-h-screen py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {showCreate && (
          ...
          >
            <div
              className="w-full max-w-md mx-4 glass rounded-2xl p-6"
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-sm text-gray-600 mb-6">
              {tab === 'mine'
                ? 'Crée ta première playlist pour organiser tes beats favoris'
                : 'Les playlists publiques apparaîtront ici'}
            </p>
            {tab === 'mine' && session && (
              <button
                onClick={() => setShowCreate(true)}
              ...
              >
                ...
                <div className="aspect-[2/1] relative overflow-hidden bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0f]">
                  ...
                  <div className="absolute bottom-2 left-3 right-3 flex items-end justify-between">
                    ...
                    <span
                      className={`flex items-center gap-1 text-xs ${playlist.visibility === 'PUBLIC' ? 'text-green-400' : 'text-orange-400'}`}
                    >
