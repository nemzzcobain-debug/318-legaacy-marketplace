    ...
    <div className="space-y-6">
      ...
      <details className="rounded-xl bg-[#13131a] border border-[#1e1e2e] p-4 group">
        ...
        <div className="mt-4 space-y-4 text-xs text-gray-400 leading-relaxed">
          ...
          <div><div className="text-white font-bold mb-1">⭐ Niveau et XP</div><p>Chaque badge te donne des points XP. Cumule-les pour monter en niveau et débloquer des privilèges.</p><div className="mt-2 space-y-1"><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#6b7280', background: '#6b728020', border: '1px solid #6b728040' }}>1</span><span className="text-gray-300 font-semibold">Débutant</span><span className="text-gray-600 ml-auto">0 XP</span></div><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#3b82f6', background: '#3b82f620', border: '1px solid #3b82f640' }}>2</span><span className="text-gray-300 font-semibold">Amateur</span><span className="text-gray-600 ml-auto">100 XP</span></div><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#8b5cf6', background: '#8b5cf620', border: '1px solid #8b5cf640' }}>3</span><span className="text-gray-300 font-semibold">Semi-Pro</span><span className="text-gray-600 ml-auto">300 XP</span></div><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#f59e0b', background: '#f59e0b20', border: '1px solid #f59e0b40' }}>4</span><span className="text-gray-300 font-semibold">Professionnel</span><span className="text-gray-600 ml-auto">700 XP</span></div><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#ef4444', background: '#ef444420', border: '1px solid #ef444440' }}>5</span><span className="text-gray-300 font-semibold">Expert</span><span className="text-gray-600 ml-auto">1500 XP</span></div><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#e11d48', background: '#e11d4820', border: '1px solid #e11d4840' }}>6</span><span className="text-gray-300 font-semibold">Maître</span><span className="text-gray-600 ml-auto">3000 XP</span></div><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#a855f7', background: '#a855f720', border: '1px solid #a855f740' }}>7</span><span className="text-gray-300 font-semibold">Légende</span><span className="text-gray-600 ml-auto">6000 XP</span></div><div className="flex items-center gap-2"><span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-[10px] font-black" style={{ color: '#ffd700', background: '#ffd70020', border: '1px solid #ffd70040' }}>8</span><span className="text-gray-300 font-semibold">Icône 318</span><span className="text-gray-600 ml-auto">10000 XP</span></div></div></div>
        </div>
      </details>
